...
void MainWindow::on_pushButton_clicked()
{
    ...
    drawingAr->placeCurrentFigure(make_shared<Triangle>());
}
...
{
    drawingAr->illustrateAction(Action::Draw);
    drawingAr->placeCurrentFigure(make_shared<Rectangle>());
}
...
{
    drawingAr->illustrateAction(Action::Draw);
    drawingAr->placeCurrentFigure(make_shared<Ellipse>());
}
